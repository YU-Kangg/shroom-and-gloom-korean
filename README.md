...
Windows Steam **0.6.21 / 빌드 25221077**용 비공식 유저 한글화입니다. 현재 버전은 **v0.1.2-beta.1**입니다. 강화 수치와 상점 보유량 표시를 수정하고, 망각 개구리 설명을 실제 선택 대상에 맞췄습니다.
...
2. Releases에서 `ShroomAndGloom-Korean-v0.1.2-beta.1-win-x64.zip`을 받습니다. GitHub의 `Source code (zip)`은 설치 파일이 아닙니다.

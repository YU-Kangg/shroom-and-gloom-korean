...
Windows Steam **0.6.21 / 빌드 25221077**용 비공식 유저 한글화입니다. 현재 버전은 **v0.1.1-beta.1**입니다.
...
2. Releases에서 `ShroomAndGloom-Korean-v0.1.1-beta.1-win-x64.zip`을 받습니다. GitHub의 `Source code (zip)`은 설치 파일이 아닙니다.
